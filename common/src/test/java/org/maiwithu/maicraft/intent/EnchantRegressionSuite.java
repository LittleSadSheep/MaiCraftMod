...
import org.maiwithu.maicraft.client.actor.MenuButtonTransactionTest;
...
import org.maiwithu.maicraft.core.task.enchant.EnchantmentQuoteTest;
...
public final class EnchantRegressionSuite {
    public static void main(String[] args) throws Exception {
        ...
        MenuButtonTransactionTest.main(args);
        EnchantmentQuoteTest.main(args);
        EnchantmentSubmissionJournalTest.main(args);
        EnchantWorkflowGuardTest.main(args);
        // 总任务暂停时菜单仍可确认附魔；恢复后应保留当时的成品与费用，而非用后来拾取的经验重新归因。
        EnchantTransactionPauseTest.main(args);
