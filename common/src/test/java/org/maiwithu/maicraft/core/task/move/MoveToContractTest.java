...
public final class MoveToContractTest {
    public static void main(String[] args) {
        ...
        var water = (MoveToTaskRecord) new MovementOps().moveTo(
                -81D, 103D, -4D, null, false, true,
                new ToolContext("water", 0));
        ...
        var assisted = (MoveToTaskRecord) new MovementOps().moveTo(
                -81D, 103D, -4D, null, false, false, "ground", true,
                new ToolContext("landing", 0));
        ...
        for (TransportMode mode : TransportMode.values()) {
            var configured = (MoveToTaskRecord) new MovementOps().moveTo(
                    -81D, 103D, -4D, null, false, true, mode.name().toLowerCase(Locale.ROOT),
                    new ToolContext("transport", 0));
        ...
        try {
            new MovementOps().moveTo(-81D, 103D, -4D, null, false,
                    false, "teleport", new ToolContext("invalid", 0));
