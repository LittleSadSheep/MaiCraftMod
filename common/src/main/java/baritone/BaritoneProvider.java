...
public final class BaritoneProvider implements IBaritoneProvider {
    ...
    public BaritoneProvider() {
        ...
        // MaiCraft owns the semantic command surface. The embedded backend must never register
        // Baritone's chat controller or accept an independent user command stream.
        this.createBaritone(Minecraft.getInstance());
    }
