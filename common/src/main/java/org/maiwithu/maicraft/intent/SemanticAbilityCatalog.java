        ...
        return switch (ability) {
            ...
            case MachineAbilityAdapter.OPERATE -> contract(
                    ...
                    fields(
                            ...
                            field("idle_ticks", "integer", "watch_production only: loaded time with no progress before Attention requests inspection; 20..max_duration_ticks, default 6000. Unloaded machines remain unknown and do not accrue inactivity."),
