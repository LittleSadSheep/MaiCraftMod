        ...
        return switch (ability) {
            ...
            case "maicraft:build", BuildDesignAdapter.ABILITY -> contract(
                    ...
                    fields(
                            ...
                            field("operation", "string", "Model operation: create_scene, update_scene, get_scene_info, get_object_info, preview, export_scene, revise_project or build (default). revise_project adopts a direct child scene revision for an idle project, preserving its policies and verified scaffolds; it changes no world blocks. These run through plan/execute; modelling operations never start body work. No operation keeps legacy semantic construction."),
