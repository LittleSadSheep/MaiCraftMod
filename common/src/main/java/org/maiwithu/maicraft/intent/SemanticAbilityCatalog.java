        ...
        return switch (ability) {
            ...
            case "maicraft:travel" -> contract(
                    ...
                    fields(
                            ...
                            field("transport_mode", "auto|ground|jetpack|elevator", "Default auto selects available native travel. Platform discovery supports ground or continuous jetpack exploration without a preselected landing. Elevator requires a located destination. Undiscovered coast/biome goals support ground/auto exploration. This grants no terrain-alteration permission."),
                            ...
                            field("semantic_target", "string", "Discover coast, a biome id/#biome_tag, platform, or lower_platform. Platform discovery keeps observing while moving; no coordinates are required."),
                            field("direction", "down|up|forward|backward|left|right|north|south|east|west", "For platform discovery only. Default forward for platform, down for lower_platform. Relative directions use the heading when travel begins. Regional radius max_distance is 8..128 (default 64)."),
