                    ...
                    schema("""
                            {
                              ...
                              "properties": {
                                ...
                                "focus":{"type":["string","null"],"maxLength":256,"description":"Ability filter for abilities; maicraft:navigation with situation includes diagnostics; with surroundings, optional literal sign text to find (for example 充气)."},
