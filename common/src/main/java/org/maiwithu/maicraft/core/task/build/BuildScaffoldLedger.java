...
final class BuildScaffoldLedger {
    ...
    private Consumer<Map<BlockPos, BlockState>> checkpoint = ignored -> {};
    private boolean persistenceBound;

    void persistence(Map<BlockPos, BlockState> restored, Consumer<Map<BlockPos, BlockState>> checkpoint) {
        ...
        placed.putAll(restored); this.checkpoint = Objects.requireNonNull(checkpoint); persistenceBound = true;
    }
