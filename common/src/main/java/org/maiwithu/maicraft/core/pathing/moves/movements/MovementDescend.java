...
import static org.maiwithu.maicraft.core.pathing.moves.ActionCosts.WALK_OFF_BLOCK_COST;
...
public class MovementDescend extends Movement {
    ...
    public MovementDescend(LocalPlayer player, BlockPos src, BlockPos dest) {
