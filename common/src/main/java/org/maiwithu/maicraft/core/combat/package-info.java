 ...
 *
 * <h2>顶层——{@link org.maiwithu.maicraft.core.combat.AttackPlan}</h2>
 * 每刻从头跑一遍的纯函数,只回答两件事:
 *
 * <ul>
 ...
 * <h2>各个类</h2>
 * <ul>
 *   <li>{@link org.maiwithu.maicraft.core.combat.AttackPlan} —— 顶层判据</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.Battlefield} —— 喂给判据的那一刻的局面</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.Menace} —— 危险半径:离它多近算危险,一处定义</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.Swing} —— 够得着多远、这一下能不能挥</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.Haven} —— 逃跑往哪儿跑(一个落点,不是一个方向)</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.Loadout} —— 手上有什么可用的</li>
 *   <li>{@link org.maiwithu.maicraft.core.combat.WeaponDamage} —— 哪把更疼</li>
 * </ul>
 *
